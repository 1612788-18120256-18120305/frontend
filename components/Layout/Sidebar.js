        ...
        <div className="px-8">
          ...
          <ul className="mt-12">
            <Link href={'/courses'}>
              <li
                className={`flex w-full justify-between ${
                  active == '/courses' ? 'text-gray-300' : 'text-gray-600'
            ...
            <Link href={'/user/account/profile'}>
              <li
                className={`flex w-full justify-between ${
                  active == '/user/account/profile' ? 'text-gray-300' : 'text-gray-600'
                } hover:text-gray-500 cursor-pointer items-center mb-6`}
              >
                <div className="flex items-center">
                  <svg
            ...
            <li
              className={`flex w-full justify-between ${
                active == '/notification' ? 'text-gray-300' : 'text-gray-600'
              } hover:text-gray-500 cursor-pointer items-center mb-6`}
            >
              <div className="flex items-center">
                <svg
            ...
            {/* <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <span className="text-sm  ml-2">Invoice</span>
              </div>
            </li>
            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
